...
public class Animation extends JFrame {
        ...
        public void prepare() {
                ...
                xh = 1200;
                yh = 700;
                b = new TestAnim[quantity];
                for (i = 0; i < quantity; i++) {
                        b[i] = new TestAnim(100, 650, 155, 0, 20, Color.black);
                }
        }
        ...
        public class TestAnim {
                int i;
                float x, y; // coordinates of objects
                float xo, yo;
                float vx, vy; // coordinates of velocity vector
                float d; // diameter
                float a = 120;
                Ellipse2D.Float wheel1;
                Ellipse2D.Float wheel2;
                Rectangle2D.Float carbody;
                Rectangle2D.Float carlight;
                Rectangle2D.Float cartop;
                Rectangle2D.Float carwindow1;
                Rectangle2D.Float carwindow2;

                // overloaded constructor

                TestAnim(int x, int y, int vx, int vy, int d, Color colour) {
                        this.x = x;
                        this.y = y;
                        this.d = d;
                        xo = x;
                        ...
                        wheel1 = new Ellipse2D.Float(x, y, d, d);
                        wheel2 = new Ellipse2D.Float(x, y, d, d);
                        carbody = new Rectangle2D.Float(x, y, d, d);
                        carlight = new Rectangle2D.Float(x, y, d, d);
                        cartop = new Rectangle2D.Float(x, y, d, d);
                        carwindow1 = new Rectangle2D.Float(x, y, d, d);
                        carwindow2 = new Rectangle2D.Float(x, y, d, d);
                ...
                public void show(Graphics g) {
                        ...
                        wheel1.setFrame(x + 15, y, d, d);
                        ((Graphics2D) g).fill(wheel1);
                        wheel2.setFrame(x - 55, y, d, d);
                        ((Graphics2D) g).fill(wheel2);
                        ((Graphics2D) g).setPaint(Color.red);
                        carlight.setFrame(x + 30, y - 10, d - 5, d - 10);
                        ((Graphics2D) g).fill(carlight);
                        ((Graphics2D) g).setPaint(Color.white);
                        carbody.setFrame(x - 60, y - 12, d + 80, d);
                        ((Graphics2D) g).fill(carbody);
                        cartop.setFrame(x - 40, y - 30, d + 33, d);
                        ((Graphics2D) g).fill(cartop);
                        ((Graphics2D) g).setPaint(Color.cyan);
                        carwindow1.setFrame(x - 35, y - 26, d, d - 5);
                        ((Graphics2D) g).fill(carwindow1);
                        carwindow2.setFrame(x - 11, y - 26, d, d - 5);
                        ((Graphics2D) g).fill(carwindow2);
